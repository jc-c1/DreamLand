      ...
      <View style={styles.container}>
        <ImageBackground
          ...
          <View style={styles.profileContainer}>
            <Image source={profileImg} style={styles.profileImage} resizeMode="contain" />
          </View>
          <View style={styles.fullText}>
            <Text style={styles.textName}>{userDetails.firstName} {userDetails.lastName}</Text>
            <Text style={styles.boldText}>Birthday:</Text>
            <Text style={styles.text}>{userDetails.dob.toDate().toDateString()}</Text>
            ...
            <Text style={styles.text}>{userDetails.favouriteStory && userDetails.favouriteStory.title}</Text>
